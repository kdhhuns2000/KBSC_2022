...
class _DonationInfoScreen extends State<DonationInfoScreen> with TickerProviderStateMixin {
  bool iconColor = true;
  ...
  void initState() {
    ...
    animation =
        Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: animationController!, curve: const Interval(0, 1.0, curve: Curves.fastOutSlowIn)));
    setData();
    super.initState();
  }
...
class _IconColorChangerState extends State<IconColorChanger> {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      icon: const Icon(Icons.favorite), //하트표시
